...
import scarletWitchGIF from '../assets/gifs/scarlet-witch.gif';
...
export default function UnderConstruction() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-scarlet-light from-15% via-scarlet-mid via-35% to-scarlet-black to-85% overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-red-400 via-red-600 to-orange-600 bg-clip-text text-transparent mb-6 animate-pulse">
            Under Enchantment
          </h1>
          <p className="text-xl md:text-2xl text-white/80 max-w-2xl mx-auto leading-relaxed">
            Brewing up something magical in the digital realm.
          </p>
        </div>
