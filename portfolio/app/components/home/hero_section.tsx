  ...
  return (
    <>
      <div className="relative flex min-h-screen flex-col overflow-x-hidden">
        {/* Background Color */}
        <div className="absolute bottom-0 left-0 right-0 top-0 bg-[var(--circle-gradient)]"></div>
        {/* Main content */}
        <div className="relative z-10 flex h-full grow flex-col">
          <div className="flex flex-1 items-center justify-center p-4 md:p-8">
            <div className="max-w-3xl text-center">
              <h1 className="text-5xl font-bold tracking-tighter text-gray-900 md:text-7xl lg:text-8xl">Kelvin Akhigbe</h1>
              <p className="mt-4 text-lg text-gray-600 md:text-xl">Full-Stack Developer, turning prescriptions into code.</p>
