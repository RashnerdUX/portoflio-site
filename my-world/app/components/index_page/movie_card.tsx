...
export const MovieCard = ({ id, index, title, releaseYear, phase, synopsis, sagaRelevance, tvaRating, posterUrl, aggregratedRating, slug }: MovieCardProps) => {
  return (
    <Link to={`/mcu-index/detail/${id}/${slug}`} className='no-underline'>
