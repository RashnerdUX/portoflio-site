...
export const MovieTile: React.FC<MovieTileProps> = ({ id, title, posterUrl, watched, onToggleSelect }) => {
  return (
        <div className="flex items-center gap-3 p-2 rounded-lg transition-all duration-300">
            ...
            <img alt={`${title} Poster`} className="w-10 h-14 object-cover rounded-md" src={posterUrl || "/images/placeholder.png"} />
